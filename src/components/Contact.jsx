...
import './Contact.css';
import { FaMapMarkerAlt, FaEnvelope, FaPhoneAlt, FaLinkedinIn, FaInstagram } from 'react-icons/fa';
        ...
        <div className="contact-body">
          ...
          <div className="contact-info">
            ...
            <div className="social-links">
              <a href="https://www.instagram.com/medinitechnologies/" className="Instagram"><FaInstagram /></a>
              <a href="https://www.linkedin.com/company/medinitechnologies/" className="linkedin"><FaLinkedinIn /></a>
            </div>
          </div>
          ...
          <div className="contact-map">
            <iframe
              ...
              allowFullScreen=""
              loading="lazy"
              title="Bentley Systems Location"
            ></iframe>
          </div>
        </div>
      </div>
      <footer className="contact-footer">
        <p>© 2025 Medini Technologies. All Rights Reserved Under Medini</p>
      </footer>
    </section>
  );
};
